...
public abstract class Icon extends ItemStackBuilder implements Cloneable {
    ...
    public Icon(Menu menu, Material material, int id, int amount, String displayName, Consumer<Player> action) {
        super(material, id, amount, displayName);
        this.menu = menu;
        this.action = action;
    }

    public Icon(Menu menu, Material material, int amount, String displayName, Consumer<Player> action) {
