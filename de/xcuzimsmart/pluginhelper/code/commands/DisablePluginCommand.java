...
@CommandInfo(name = "disableplugin", permission = "pluginhelper.commands.operation", description = "Disables Plugins.")
public class DisablePluginCommand extends PluginCommand {
